...
RELEASE_VERSION=$1 docker-compose -f docker-compose.push.yml push
scp docker-compose.yml just1ce@185.249.255.224:~/vk-tasks
scp docker-compose.infra.yml just1ce@185.249.255.224:~/vk-tasks
scp docker-compose.push.yml just1ce@185.249.255.224:~/vk-tasks
...
RELEASE_VERSION=$1 docker-compose -f docker-compose.push.yml pull &&
./reload.sh $1"
