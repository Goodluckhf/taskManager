...
describe('cleanLink', () => {
	...
	it('Should clean if there is away.php', () => {
		const url =
			'https://vk.com/away.php?to=https%3A%2F%2Fgithub.com%2Fsearch%3Futf8%3D%25E2%259C%2593%26q%3Dasdasd%26type%3D&post=-148143523_3186&cc_key=';
	...
	it('should clean "/" if there is away.php', () => {
		const url =
			'https://vk.com/away.php?to=https%3A%2F%2Fgithub.com%2Fsearch%2F&post=-148143523_3186&cc_key=';
		const cleaned = cleanLink(url);
	...
	it('should clean "?" if there is away.php', () => {
		const url =
			'https://vk.com/away.php?to=https%3A%2F%2Fgithub.com%2Fsearch%3F&post=-148143523_3186&cc_key=';
		const cleaned = cleanLink(url);
		expect(cleaned).to.be.equals('github.com/search');
	});
});
