...
import {
	...
	Input, CardFooter, Label, Row, Col,
}                           from 'reactstrap';
...
class Form extends PureComponent {
	...
	render() {
		return (
			<Card>
				<CardHeader><b>Добавить Задачу на слежку</b></CardHeader>
				<CardBody>
					<BootstrapForm>
						<FormGroup>
							<Row>
								<Col>
									...
									<Input onChange={this.handleLink} type='text' placeholder='https://vk.com/nice.advice'/>
								</Col>
								<Col>
									<Label>Кол-во постов</Label>
									<Input onChange={this.handlePostCount} type='number' value={this.state.postCount}/>
								</Col>
							</Row>
