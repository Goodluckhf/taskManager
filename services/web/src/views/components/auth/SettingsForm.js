...
class Form extends PureComponent {
	...
	render() {
		return (
			<Card>
				<CardHeader><b>Настройки аккаунта</b></CardHeader>
				<CardBody>
					...
					<BootstrapForm>
						<FormGroup>
							<Row>
								...
								{this.props.loadingUserData ? 'Загружаю...' :
									<Col sm='12'>
										<Label>Ссылка на профиль vk.com:</Label>
										{!this.props.chatId &&
											<Input onChange={this.onLinkChange} type='text' placeholder='https://vk.com/id123'/>
										}
										{this.props.chatId && <a rel='noopener noreferrer' target='_blank' href={this.props.vkLink}>{this.props.vkLink}</a>}
									</Col>
								}
							</Row>
						</FormGroup>
